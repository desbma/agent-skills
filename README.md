...
- [`review-loop`](review-loop/SKILL.md): Run reviews sequentially, one domain per round. Mostly superseded by `review-auto-loop`.
- Per-domain review skills (called by the `review-*loop` skills):
